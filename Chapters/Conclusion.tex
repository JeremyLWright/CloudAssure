...
Neural nets, offer an extremely advanced classification properties dues directly
to their non-linearity. We choose to skip these in order to tune the linear
techniques, but the linear techniques reviewed are insufficient to my strong
claims about the generality of CloudAssure's classification effectively. 
