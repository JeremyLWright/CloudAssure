...
a single document from Node ‘A' to Node ‘B' is shown in the
Figure~\ref{fig:DataTransmission}.
\begin{figure}[h!]
    \begin{center}
...
Figure~\ref{fig:TrustTransmission}. explains the steps of transmission of data from Node ‘A' at level –I
...
\begin{figure}[h!]
    ...
    \begin{center}
        \includegraphics[width=0.90\textwidth]{Figures/Trust_Algorithm.jpg}
